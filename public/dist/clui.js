...
var clui = (function (exports) {
    ...
    /* src/Clui.svelte generated by Svelte v3.38.3 */
    const file = "src/Clui.svelte";
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div3 = element("div");
    			div1 = element("div");
    			div1.textContent = "Command A";
    			t2 = space();
    			div2 = element("div");
    			div2.textContent = "Command B";
    			t4 = space();
    			div4 = element("div");
    			this.c = noop;
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	validate_slots("clui-main", slots, []);
    	window.clui = new CLUI();
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<clui-main> was created with unknown prop '${key}'`);
    	});

    	$$self.$capture_state = () => ({ CLUI });
    	return [];
    }

    class Clui extends SvelteElement {
    	constructor(options) {
    		super();
    		this.shadowRoot.innerHTML = `<style>#clui-fragment{color:white}</style>`;
    ...
    customElements.define("clui-main", Clui);
